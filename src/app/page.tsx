        ...
        >
          <div className="text-center">
            ...
            <p className="font-semibold text-base lg:text-lg mt-8">
              Tracui lets you track any product&apos;s journey with just a tap
              or scan — from origin to delivery.
            </p>
            <div className="mt-8 ">
              <Link
                href="/scan"
          ...
          <div className="2xl:container mx-auto">
            <div className="text-white text-center">
              ...
              <p className="text-sm lg:text-xl mt-8 lg:w-1/2 mx-auto">
                ...
                adapts to you. Built with flexibility, designed for
                transparency.
              </p>
            </div>
          ...
          <div className="2xl:container mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 px-[10%] lg:px-[20%] mt-10 lg:mt-20">
              {ReasonsItems.map((item, index) => (
                <div
                  key={index}
                  className="p-8 lg:p-10 rounded-lg bg-[#343434] border border-white"
                >
